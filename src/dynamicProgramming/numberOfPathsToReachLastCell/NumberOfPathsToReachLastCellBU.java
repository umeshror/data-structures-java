package dynamicProgramming.NumberOfPathsToReachLastCellBU;

import node.NumberOfPathsNode;

public class NumberOfPathsToReachLastCellBU {
    ...
    public static void main(String[] args) {
        ...
        NumberOfPathsToReachLastCellBU nop = new NumberOfPathsToReachLastCellBU();
